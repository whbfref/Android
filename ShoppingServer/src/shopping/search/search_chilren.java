...
public class search_chilren extends HttpServlet{

	/**
	 * 
	 */
	private static final long serialVersionUID = 691501177425033183L;

	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		kConnDB conn = new kConnDB();
		String sql = "select ClothesId,ClothesName,ClothesSave,ClothesUrl,ClothesPrice from Clothes where ClothesId like '1%'";
