...
public class search_clothes extends HttpServlet{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2656197786950940300L;
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "select ClothesId,ClothesName,ClothesSave,ClothesUrl,ClothesPrice from Clothes,Style  where Clothes.StyleId=Style.StyleId and Style.ClothesSex='"+sex+"'and Style.ClothesColor='"+color+"'and Style.ClothesSize='"+size+"'and Clothes.ClothesId like '0%'";
